...
def main(args):
    ...
    anneal_lr = config.get("anneal_lr", False)
    ...
    console = Console()
    title = (
        f":rocket: :rocket: :rocket: [bold red] Training {env_id}" f" with PPO [/bold red] :rocket: :rocket: :rocket:"
    )
