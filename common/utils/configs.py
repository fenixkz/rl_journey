CONFIGS = {
    ...
    "acrobot": {"env_id": "Acrobot-v1", "solved_reward": -100.0, "description": "Swing up underactuated pendulum"},
    "taxi": {"env_id": "Taxi-v3", "solved_reward": 9.0, "description": "Train a self-driving taxi"},
}
