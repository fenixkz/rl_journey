...
def parse_args():
    ...
    parser.add_argument("--agent", type=str, default="q-learning", choices=["q-learning", "sarsa", "ev-sarsa"])
    parser.add_argument(
        "--env",
        type=str,
        default="taxi",
...
def main(args):
    ...
    save_path = f"results/{args.agent}/{env_id}"
    os.makedirs(save_path, exist_ok=True)

    console = Console()
    title = f":rocket: :rocket: :rocket: [bold red] Training {env_id} with {args.agent} [/bold red] \
