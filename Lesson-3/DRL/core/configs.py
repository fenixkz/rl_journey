...
DEFAULT_ATARI_PARAMS = {
    ...
    "gamma": 0.995,                 # Slightly higher for Box2D long-term rewards # Gamma of TD update rule
    "memory_size": int(1e6), # Replay or PER total size
    "learning_starts": 8e4, # How much to samples to gather before the learning starts
    ...
    "noise_std": 0.5, # Standard deviation for noise initialization
}
...
DEFAULT_CLASSIC_PARAMS = {
    ...
    "lr": 5e-5,                     # We can use a higher lr
