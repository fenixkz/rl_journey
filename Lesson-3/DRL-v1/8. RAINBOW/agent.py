...
from core.policies import NoisyDistributionalDuelingFC, NoisyDistributionalDuelingCNN
...
class AgentDQN(DQNBase):
    ...
    def __init__(self, env: gym.Env, agent_config: AgentConfig, env_config: Dict, is_atari: bool):
        ...
        self.v_min = -10.0  # Minimum value of support
        self.v_max = 10.0   # Maximum value of support
        ...
        # ---------- NOISY NET PARAMS ------------
        self.noisy_std = 0.5  # Standard deviation for noise initialization
        
        # Override the policy networks with RAINBOW versions (Noisy + Distributional + Dueling)
        self._setup_rainbow_networks(agent_config)

    def _setup_rainbow_networks(self, agent_config: AgentConfig):
