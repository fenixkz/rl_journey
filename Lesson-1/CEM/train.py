...
from utils.classic_config import CLASSIC_ENV_CONFIG  # noqa: E402
from utils.config_utils import save_as_json  # noqa: E402
from utils.plot_utils import get_figure  # noqa: E402
...
def main(args):
    ...
    if VISUALIZE:
        # Create a similar env
        # but that can visualize the environment
        # using display
    ...
    def save_progress():
        ...
        # 2. Save config
        # But first add seed as hyperparam to config
        config["seed"] = seed
